...
# スクリプトを実行
extract_circles_near_point_with_hough_transform(tolerance=0.01, distance_threshold=0.5, image_size=1000, dp=1.2, min_dist=10, param1=50, param2=30, min_radius=30, max_radius=60)